...
const socialLinks: SocialLink[] = [
  {
    name: 'GitHub',
    url: 'https://github.com/ErickSantos2002',
    icon: 'github',
  },
  {
    name: 'LinkedIn',
    url: 'https://www.linkedin.com/in/erick-santos2002/',
    icon: 'linkedin',
  },
  {
    name: 'Email',
    url: 'mailto:ericksantosdantas@gmail.com',
    icon: 'email',
  },
];

/**
 * Retorna o ícone SVG correspondente ao nome
 * @param iconName - Nome do ícone (github, linkedin, email)
 */
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div ref={titleRef} className="text-center mb-16 scroll-reveal">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              ...
              <span className="heading-gradient">Contato</span>
            </h2>
          ...
          {/* Contact Card */}
          <div ref={cardRef} className="bg-gradient-to-br from-primary-500 to-blue-600 rounded-3xl p-1 scroll-reveal-scale">
            <div className="bg-white dark:bg-gray-900 rounded-3xl p-8 md:p-12">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 dark:text-gray-400">
                  ...
                  criativas ou oportunidades de colaboração.
                </p>
              </div>
              ...
              <div className="flex flex-wrap justify-center gap-4">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="flex items-center gap-3 px-6 py-4 bg-gray-50 dark:bg-gray-800 hover:bg-primary-50 dark:hover:bg-primary-900/30 rounded-xl transition-all duration-300 hover:scale-105 group"
                  >
