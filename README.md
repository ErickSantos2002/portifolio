# Portfolio - Erick Santos

Portfolio pessoal de Erick Santos, Cientista de Dados e Desenvolvedor Full Stack.
...
```bash
git clone https://github.com/ErickSantos2002/portifolio.git
cd portifolio
```
...
```typescript
{ name: 'Nome da Tecnologia', category: 'frontend' | 'backend' | 'data-science' | 'tools' }
```
...
- **LinkedIn**: [linkedin.com/in/erick-santos2002](https://www.linkedin.com/in/erick-santos2002/)
- **GitHub**: [github.com/ErickSantos2002](https://github.com/ErickSantos2002)
...
Desenvolvido com ❤️ por [Erick Santos](https://github.com/ErickSantos2002)
